...
python3 run_regression_experiment.py --model-identifier gpt-3.5-turbo-0125 --dataset-name trivia_qa --device cuda:0 --num-training-steps 600 --num-in-context-samples 10 --data-dir $data_dir --model-save-dir $model_save_dir --result-dir $result_dir --lr 0.00001625 --weight-decay 0.01362 --push-to-hub
